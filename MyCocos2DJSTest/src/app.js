...
var HelloWorldLayer = cc.Layer.extend({
    ...
    ctor: function () {
        ...
        var spriteSelected = new cc.Sprite(res.ItemSelected_png);
        ...
        spriteNormal = new cc.Sprite(res.Item5Normal_png);
        spriteSelected = new cc.Sprite(res.ItemSelected_png);
        ...
        helloLabel.runAction(
            cc.spawn(
                cc.moveBy(0.8, cc.p(0, size.height - 40)),
                cc.tintTo(0.8, 255, 125, 0)
            )
        );
        return true;
    },
